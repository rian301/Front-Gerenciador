...
import { PendencyDocComponent } from '../../financial/pendency/pendency-doc/pendency-doc.component';

@Component({
  selector: 'app-gift-doc',
  templateUrl: './gift-doc.component.html',
  styleUrls: ['./gift-doc.component.scss']
})
export class GiftDocComponent extends OnDestroySubscriptions implements OnInit {
